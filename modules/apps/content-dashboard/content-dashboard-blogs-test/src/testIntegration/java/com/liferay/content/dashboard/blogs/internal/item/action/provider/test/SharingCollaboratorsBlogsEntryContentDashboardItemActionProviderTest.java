...
public class
	SharingCollaboratorsBlogsEntryContentDashboardItemActionProviderTest {
	...
	@Inject(
		filter = "component.name=com.liferay.content.dashboard.blogs.internal.item.action.provider.SharingCollaboratorsBlogsEntryContentDashboardItemActionProvider"
	)
